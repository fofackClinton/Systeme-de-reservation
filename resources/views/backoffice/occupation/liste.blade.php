      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> {{ number_format($occ->montat, thousands_separator: ' ') }} XAF</td>
                <td> {{ number_format($occ->montatpayer , thousands_separator: ' ') }} XAF</td>
                <td> {{ number_format($occ->restepayer, thousands_separator: ' ') }} XAF</td>
